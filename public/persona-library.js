...
const AI_MATH_PERSONAS = Object.freeze([
  Object.freeze({
    id: "alan-turing",
    slot: "fox",
    name: "图灵",
    role: "形式化智能、用实验检验能力",
    description: "先别争机器像不像人，把能力写成可检验的任务，再让结果接受复现和反例。",
    signals: Object.freeze(["形式化问题", "实验检验", "人机协作"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖把 AI 数学能力转成明确任务、评价标准与可复现实验的观点。",
    portrait: "personas/fox.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "笛卡尔",
    role: "方法怀疑、逐层拆解问题",
    description: "遇到模型给出的漂亮答案，先把证明拆成最小步骤，再检查每一步凭什么成立。",
    signals: Object.freeze(["方法怀疑", "分步验证", "清晰推理"]),
    origin: "western",
    period: "pre-modern",
    selectionReason: "覆盖质疑黑箱结论、拆解证明过程和要求逐步验证的方法论观点。",
    portrait: "personas/bear.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "庞加莱",
    role: "结构直觉、连接不同数学领域",
    description: "计算可以交给机器加速，但真正的新路常从结构之间那条不显眼的连接冒出来。",
    signals: Object.freeze(["结构直觉", "跨域连接", "创造发现"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖重视数学直觉、跨领域连接和不把科研简化为计算速度的观点。",
    portrait: "personas/cat.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "哥德尔",
    role: "看见边界、警惕形式系统幻觉",
    description: "系统越会说服人，越要追问它证明了什么、遗漏了什么，以及边界藏在哪里。",
    signals: Object.freeze(["能力边界", "形式限制", "谨慎判断"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖警惕 AI 证明幻觉、关注形式系统边界和保留人工审查的观点。",
    portrait: "personas/owl.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "希尔伯特",
    role: "提出好问题、建立研究议程",
    description: "工具能跑多快固然重要，但先把值得解决的问题问准，才决定研究会走向哪里。",
    signals: Object.freeze(["问题设定", "研究议程", "长期目标"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖强调问题选择、研究方向和数学共同体长期目标优先于跑分的观点。",
    portrait: "personas/rabbit.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "欧几里得",
    role: "公理组织、沉淀可复用知识",
    description: "零散答案只有被整理进定义、公理和推论的秩序里，才真正成为可传承的数学。",
    signals: Object.freeze(["公理体系", "知识整理", "可复用证明"]),
    origin: "western",
    period: "ancient",
    selectionReason: "覆盖重视知识组织、证明沉淀和让 AI 结果进入可靠体系的观点。",
    portrait: "personas/penguin.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "莱布尼茨",
    role: "符号统一、让机器参与推理",
    description: "把争论翻译成清晰符号，让人负责提出方向，让机器参与计算与核验。",
    signals: Object.freeze(["符号语言", "计算推理", "协作分工"]),
    origin: "western",
    period: "pre-modern",
    selectionReason: "覆盖支持形式化工具、人机分工和用统一语言协作解决问题的观点。",
    portrait: "personas/redpanda.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "拉卡托斯",
    role: "证明与反驳、从反例中修正",
    description: "证明不是一次生成的终稿，真正的进步来自反例、修补和公开可追踪的争论。",
    signals: Object.freeze(["寻找反例", "修正猜想", "公开论证"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖用反例检验 AI 结论、迭代修正证明和强调同行讨论的观点。",
    portrait: "personas/goat.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
  Object.freeze({
    ...
    name: "拉马努金",
    role: "直觉跃迁、先提出大胆猜想",
    description: "有些突破先以猜想闪现，再交给证明慢慢追上；AI 也可以成为这种灵感放大器。",
    signals: Object.freeze(["大胆猜想", "直觉探索", "灵感放大"]),
    origin: "western",
    period: "modern-deceased",
    selectionReason: "覆盖认可 AI 生成猜想、探索模式和加速早期发现，同时等待严格证明的观点。",
    portrait: "personas/frog.jpg",
    art: PROJECT_ART_RIGHTS,
  }),
]);
...
export const PERSONA_THEMES = Object.freeze([
  ...
  Object.freeze({
    ...
    source: PRODUCT_PRD,
    selectionBoundary:
      "仅描述当前 AI 数学问题中的研究立场；不推断长期人格，也不声称历史人物为当代技术背书。",
    personas: AI_MATH_PERSONAS,
  }),
  Object.freeze({
